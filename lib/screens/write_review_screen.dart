...
class _WriteReviewScreenState extends State<WriteReviewScreen> {
  static const String iframeUrl = 'https://dev-reviews.offerx.global';
  static const String targetOrigin = 'https://dev-reviews.offerx.global';
  ...
  void initState() {
    super.initState();
    debugPrint('Initializing WriteReview WebView');
  ...
  void _handleWebViewCreated(InAppWebViewController controller) {
    debugPrint('WriteReview WebView created');
  ...
  void _handleLoadStop(InAppWebViewController controller, WebUri? url) async {
    debugPrint('✅ WriteReview page finished loading: $url');
  ...
  void _handleLoadError(InAppWebViewController controller,
    ...
    debugPrint('❌ WriteReview web resource error: ${error.description}');
...
<body>
  ...
  <script>
    ...
    function sendPayload() {
      ...
      const message = {
        apiPayload: [
          {
            iframeType: "writeAReview",
            token: latestToken,
            payLoad: {
              externalRefId: "123123",
              companyWebsite: "https://example.com",
              candidateJSONDetails: {
                email: "loadtest49@gmail.com",
                firstName: "Joshn",
                lastName: "Doe",
                dob: "1990-01-01",
                gender: 0,
              ...
              companyName: "testqwdtfsaafatassany",
              companyAddress: "123 Test St, Test City",
              ownerName: "Test",
              ownerPhoneNumber: "1231231231",
              postalCode: "123456",
              companyOwnerEmail: "eee225@yopmail.com",
            },
          },
        ],
      };
    ...
    function launchIframe() {
      ...
      iframe.src = IFRAME_URL + "?_=" + Date.now();
    ...
    // Listen for READY message from iframe (similar to React Native code)
  ...
  void _handleMessageFromIframe(List<dynamic> args) {
    ...
    debugPrint('=== RECEIVED MESSAGE FROM WRITE REVIEW IFRAME ===');
